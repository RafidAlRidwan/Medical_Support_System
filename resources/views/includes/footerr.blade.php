...
<h3>Medical Support System</h3>
     ...
     <div class="module-body m-t-20">
        ...
        <a href="#"><i class="icon fa fa-pinterest"></i></a> <br>
        <div>
    ...
    <div class="module-body outer-top-xs">
        <div class="table-responsive">
            <table class="table">
                    ...
                    <strong>Doctor's Appointment</strong><br><br>
                    <strong>Ambulance Reserve</strong> <br><br>
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <p>+8801721914666<br>+8801924146965</p>
                </div>
            </li>
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <span><a href="#">medical.s.s@support.com</a></span>
