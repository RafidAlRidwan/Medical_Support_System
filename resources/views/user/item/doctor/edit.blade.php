...
<div class="form-group">
       ...
       <input type="email" class="form-control unicase-form-control text-input" id="email" value="{{$user->email}}" readonly>
            ...
            <div class="form-group">
              ...
              <textarea type="text" class="form-control unicase-form-control text-input" id="address" name="address" required="required" value="{{$user->address}}"> </textarea>
            </div>
...
<div class="form-group">
       ...
       <input type="password" class="form-control unicase-form-control text-input" id="newpass" name="newpass">
        ...
        @include('includes.myaccount-sidebar')
     </div><!-- /.row -->
    </div><!-- /.checkout-box -->
