...
<div class="form-group">
            ...
            <input type="text" class="form-control unicase-form-control text-input" id="contact_no" placeholder="+88" name="contact_no" maxlength="14" required >
        </div>

 <div class="form-group">
            <label class="info-title" for="address">Address <span>*</span></label>
            <input type="address" class="form-control unicase-form-control text-input" id="address" placeholder="" name="address"  required >
        </div>
