        ...
        <div class='row outer-bottom-sm'>
            ...
            <div class='col-md-9'>
              <div id="category" class="category-carousel hidden-xs">
                <div class="item">  
                  <div class="image">
                     <img src="{{asset('user/assets/images/banners/cat-banner-12.jpg')}}" width="900" height="255" img-responsive">
                  </div>
                ...
                <div class="search-result-container">
                    <div id="myTabContent" class="tab-content">
                       ...
                       <div class="product-info text-left">
                         <h3 class="name"><a href="{{route('ambulance.show', $object8->id)}}">{{$object8->item_name}} </a></h3>
